...
var Counter = /** @class */ (function () {
    function Counter(timer) {
        this.timer = timer;
        this.started = false;
        this.numStart = typeof this.timer.dataset.start != 'undefined' ? this.timer.dataset.start : 0;
        ...
        this.speed = typeof this.timer.dataset.speed != 'undefined' ? this.timer.dataset.speed : 100;
        this.increment = typeof this.timer.dataset.increment != 'undefined' ? this.timer.dataset.increment : 0;
        this.displayLoop();
    }
...
var Radial = /** @class */ (function (_super) {
    ...
    function Radial(timer) {
        ...
        _this_1.cClockwise = typeof _timer.dataset.cclockwise != 'undefined' ? _this_1.timer.dataset.cclockwise : false;
        ...
        _this_1.radialColor = typeof _timer.dataset.color != 'undefined' ? _this_1.timer.dataset.color : '#000';
        _this_1.startColor = _this_1.radialColor;
        _this_1.endColor = typeof _timer.dataset.endcolor != 'undefined' ? _this_1.timer.dataset.endcolor : _this_1.radialColor;
...
var counters = [], counterBlocks = document.querySelectorAll('.js-counter');
for (var i = 0; i < counterBlocks.length; ++i) {
    counters[i] = new Counter(counterBlocks[i]);
}
var radials = [], radialBlocks = document.querySelectorAll('.js-radial');
for (var i = 0; i < radialBlocks.length; i++) {
    radials[i] = new Radial(radialBlocks[i]);
}
var grids = [], gridBlocks = document.querySelectorAll('.js-grid');
