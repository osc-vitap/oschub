...
class Profile(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        Quary2 = EventUserData.objects.filter(
            studentEmail=request.user.email, studentCheckedIn=True
        )
        Quary3 = EventUserData.objects.filter(
            studentEmail=request.user.email, studentCheckedIn=False
        )
